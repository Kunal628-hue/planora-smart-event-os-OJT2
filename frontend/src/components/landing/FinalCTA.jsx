...
export default function FinalCTA() {
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 5rem", position: "relative", zIndex: 1 }}>
        ...
        >
          Join hundreds of organizations already using Planora to run smarter, faster, better events.
        </p>
