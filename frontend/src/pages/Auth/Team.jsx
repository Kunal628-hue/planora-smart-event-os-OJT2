    ...
    return (
        <div>
            <div style={{ marginBottom: "2rem" }}>
                <h1 style={{ fontSize: "1.75rem", fontWeight: 800, color: "var(--text-primary)" }}>Team</h1>
                <p style={{ color: "var(--text-secondary)", fontWeight: 500 }}>Collaborate with your team and assign roles.</p>
            </div>
            <div className="card" style={{ padding: "5rem 2rem", textAlign: "center", border: "1px dashed var(--border-subtle)" }}>
                ...
                <h2 style={{ fontSize: "1.5rem", fontWeight: 850, marginBottom: "0.75rem" }}>Solo planning?</h2>
                <p style={{ color: "var(--text-secondary)", marginBottom: "2rem", maxWidth: "400px", margin: "0 auto 2rem" }}>Invite teammates to help you plan events more efficiently.</p>
                <button className="btn btn-primary" style={{ background: "var(--accent-primary)" }}>Invite Teammate</button>
            </div>
        </div>
    );
}
