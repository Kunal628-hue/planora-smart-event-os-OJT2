                ...
                <div className="auth-card-split">
                    ...
                    <div className="auth-form-side">
                        <div className="auth-form-container">
                            ...
                            <p className="form-subheading">Enter your credentials to access your dashboard</p>
                            ...
                            <div className="auth-footer-links">
                                <p>Need an account? <Link to="/signup">Join Planora</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
