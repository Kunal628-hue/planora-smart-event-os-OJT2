...
const guestSchemas = {
    create: Joi.object({
        ...
        phone:      fields.phone.optional().allow("", null),
        whatsapp:   fields.phone.optional().allow("", null),
        status:     Joi.string().valid("Pending", "Confirmed", "Declined", "Rejected").optional().allow("", null),
        familySize: Joi.number().integer().min(0).max(100).optional().allow(null),
        category:   fields.shortText(50).optional().allow("", null),
        linkedIn:   fields.url.optional().allow("", null),
        portfolio:  fields.url.optional().allow("", null),
        rejectionReason: fields.longText(1000).optional().allow("", null),
        dietary:    fields.shortText(50).optional().allow("", null),
        notes:      fields.longText(5000).optional().allow("", null),
        checkedIn:   Joi.boolean().optional(),
        checkedInAt: Joi.date().optional().allow(null, ""),
        event:      fields.objectId.optional().allow("", null),
        eventId:    fields.objectId.optional().allow("", null),
        user:       fields.firebaseUid.optional().allow("", null),
    }),
    update: Joi.object({
        name:       fields.shortText(80).optional().allow("", null),
        email:      fields.email.optional().allow("", null),
        phone:      fields.phone.optional().allow("", null),
        whatsapp:   fields.phone.optional().allow("", null),
        status:     Joi.string().valid("Pending", "Confirmed", "Declined", "Rejected").optional().allow("", null),
